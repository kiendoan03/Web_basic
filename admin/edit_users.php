...
<body>
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Edit user</li>
                    ...
                    <div class="row">
                        <h3 class="text-danger">Doan Trung Kien : Admin</h3>
                        <div class="row mt-2">
                            <form>
                                <!-- <div class="alert alert-danger">Password mismatch!</div> -->
                                <div class="mb-3">
                                    <label>Name</label>
                                    <input name="user_name" value="Doan Trung Kien" required class="form-control" placeholder="">
                                </div>
                                <div class="mb-3">
                                    <label for="exampleFormControlInput1" class="form-label">Email address</label>
                                    <input type="email" class="form-control" value="kien@gmail.com" id="exampleFormControlInput1" placeholder="name@example.com">
                                </div>
                                <div class="mb-3">
                                    <label for="inputPassword5" class="form-label">Password</label>
                                    <input type="password" id="inputPassword5" class="form-control" value="123456" aria-describedby="passwordHelpBlock">
