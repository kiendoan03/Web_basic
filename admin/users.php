                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <a href="edit_users.php" class="btn btn-warning"><i class="fa-solid fa-pen-to-square"></i></a>
                                    <a href="#" class="btn btn-danger text-decoration-none"><i class="fa-solid fa-xmark"></i></a>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row">2</th>
                                <td>Doan Trung Kien</td>
                                <td>kien@gmail.com</td>
                                <td><span class="label label-danger">Admin</span></td>
                                <td> <a href="edit_users.php" class="btn btn-warning"><i class="fa-solid fa-pen-to-square"></i></a>
        ...
        <span aria-hidden="true">&raquo;</span>
                ...
                <div class="row">
                    <div id="add_member" class="row mt-3">
                        <a href="add_users.php" class="btn btn-info " style="display: inline-block;">
