...
<body>
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a class="text-decoration-none text-dark"  href="category.php"><i class="fa-solid fa-list-check"></i> Category management</a></li>
    <li class="breadcrumb-item active" aria-current="page">Edit category</li>
                    ...
                    <!-- <div class="row mt-2">
                        <ol class="breadcrumb">
                            ...
                            <li>
                                <a class="text-decoration-none text-dark" href="category.html "> <i class="fa-solid fa-list-check"></i> Category manage </a>
                            </li>
                            <li class="active"><span>/</span>Edit category</li>
                        </ol>
                    ...
                    $queryAllCategories = mysqli_query($conn, $sqlAllCategories);
                    $cate = mysqli_fetch_assoc($queryAllCategories);
                    $sqlnamecate = "SELECT name_cate FROM category WHERE id_cate= ".$_GET['id_cate'];
                    $name_cate=mysqli_query($conn, $sqlnamecate);
                    $name = mysqli_fetch_assoc($name_cate);
                    ?>
                        ...
                        <?php
                            ...
                            <form method="post"  action="" role="form">
                                <div class="mb-3">
                                    ...
                                    <input name="category_name" type="text"  class="form-control" placeholder="">
                                </div>
                                
                                <input type="submit" name="sbm" class="btn btn-danger" value = "Update"></input>
