                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="edit_category.php?id_cate=<?php echo $cate['id_cate'];?>" name="" class="btn btn-warning mb-2"><i class="fa-solid fa-pen-to-square"></i></a>
                                    <a href="del_category.php?id_cate=<?php echo $cate['id_cate'];?>" name="" class="btn btn-danger text-decoration-none mb-2"><i class="fa-solid fa-xmark"></i></a>
                                </td>
                            </tr>
                            <?php
        ...
        <span aria-hidden="true">&raquo;</span>
                ...
                <div class="row">
                    <div id="add_member" class="row mt-3">
                        <a href="add_category.php" class="btn btn-info " style="display: inline-block;">
