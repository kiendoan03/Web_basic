                    ...
                    <div class="row">
                        <div class="title text-center text-info">
                            <div class="row mb-3 fs-1">
                                <span>YOU NEED WE HAVE</span>
                            </div>
                            <img src="public/images/buy-only-what-you-need.jpg" alt="">
                        </div>
                    </div>
                    <div class="row mt-3">
                        <span class="mb-3"> In the era of technology development, high-tech devices become more and more popular.</span>
                        <img src="public/images/cach-mang-4-0.jpg" width="300" height="300" alt="">
                        <span class="mt-3 mb-3">Therefore, understanding the requirements of customers, DWG have cooperated with Apple to distribute genuine products in Vietnam with many different products and models. This is to ensure that the products delivered to customers are always genuine and of high quality.</span>
                        <img src="public/images/apple.jpg" alt="">

                        <span class="mt-3 mb-3">We specialize in providing genuine Apple products such as iPhone, Macbook, and accessories.</span>
                        <img src="public/images/-16479172157351959647924.jpg" alt="">


                        <span class="mt-3 mb-3">We are always improving to give our customers the best shopping experience. What are you waiting for, press the "buy now" button to accompany us.</span>
                        <div class="row text-center">
                            <div class="card-footer text-muted">
                                <a href="home.html" class="btn btn-danger">Buy now</a>
